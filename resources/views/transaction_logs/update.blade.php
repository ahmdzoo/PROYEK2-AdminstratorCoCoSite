                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ url('/AddNewTransaction') }}" method="POST"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <label for="">Nama Pelanggan</label>
                                            <input type="text" name="customer_name"
                                                placeholder="Masukkan Nama Pelanggan" class="form-control mb-2">
                                            <label for="">Layanan</label>
                                            <input type="text" name="service" placeholder="Masukkan Layanan"
                                                class="form-control mb-2">
                                            <label for="">Produk</label>
                                            <input type="text" name="product" placeholder="Masukkan Produk"
                                                class="form-control mb-2">
                                            <label for="">Tagihan</label>
                                            <input type="number" name="bill" placeholder="Masukkan Tagihan"
                                                class="form-control mb-2">
                                            <label for="">Nomor WA</label>
                                            <input type="text" name="whatsapp_number" placeholder="Masukkan Nomor WA"
                                                class="form-control mb-2">
                                            <label for="">Alamat</label>
                                            <input type="text" name="address" placeholder="Masukkan Alamat"
                                                class="form-control mb-2">
